...
describe TradesController do
  ...
  let(:valid_attributes) { { "trader1_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trade as @trade" do
        ...
        post :create, {:trade => { "trader1_id" => "invalid value" }}, valid_session
        assigns(:trade).should be_a_new(Trade)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trade" do
        ...
        Trade.any_instance.should_receive(:update_attributes).with({ "trader1_id" => "1" })
        put :update, {:id => trade.to_param, :trade => { "trader1_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trade as @trade" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trade.any_instance.stub(:save).and_return(false)
        put :update, {:id => trade.to_param, :trade => { "trader1_id" => "invalid value" }}, valid_session
        assigns(:trade).should eq(trade)
      end
